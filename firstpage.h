...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(356, 119);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(211, 46);
			this->label2->TabIndex = 1;
			this->label2->Text = L"ARE YOU ";
			...
			this->button1->Size = System::Drawing::Size(364, 178);
			this->button1->TabIndex = 2;
			this->button1->Text = L"A FREELANCER LOOKING FOR WORK ";
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 24, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(484, 248);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(362, 178);
			this->button2->TabIndex = 3;
			this->button2->Text = L"AN ORGANIZATION WILLING TO HIRE ";
